 ...
 * Date: 01-15-2020
 * 
 * Modified version of Y. Daniel Liang's ClockPane class that includes
 * hand visibility.
 */
...
public class ClockPane extends Pane {
	...
	public void setHourHandVisible(boolean visibility) {
		hourHandVisible = visibility;
	}
	
	/** Return minute hand visibility */
	...
	public void setMinuteHandVisible(boolean visibility) {
		minuteHandVisible = visibility;
	}
	
	/** Return second hand visibility */
