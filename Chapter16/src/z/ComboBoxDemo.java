package z;
/*
 * Summary: This application makes use of DescriptionPane and a combo box. The combo
 * box selections are the actions. Combo boxes are setup like so: ComboBox<String> cbo
 * = new ComboBox<>(). setDisplay sets the display of the first item in the combo
 * box. setDisplay is a method that invokes each element that is changed by the 
 * combo box.
 */
...
public class ComboBoxDemo extends Application {
	...
	private ImageView[] flagImage = { new ImageView("PoggersLeft.png"), new ImageView("PoggersRight.png"),
