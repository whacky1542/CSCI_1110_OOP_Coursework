package z;
/*
 * Summary: With Slider objects you can have a different look to a scroll bar!
 */
...
public class SliderDemo extends Application {
	...
	public void start(Stage primaryStage) {
		...
		slVertical.valueProperty().addListener(ov -> text
				.setY((slVertical.getMax() - slVertical.getValue()) * paneForText.getHeight() / slVertical.getMax()));
