package z;
/*
 * Summary: To use scroll bars, use ScrollBar. Default orientation is horizontal it seems so set
 * any intended verticals as .setOrientation(Orientation.VERTICAL). It also seems that borderpane
 * is the best tool for scrolling setups. It also seems that .valueProperty().addListener(ov -> 
 * text.setX()); will be necessary for scroll bar manipulation.
 */
